...
const SuperDBError = require('./Error.js');
const fs = require('fs');
...
class SuperDBObject {
    ...
    save() {
        ...
        Object.entries(this).forEach((i) => {
            if (!validValue(i[1])) throw new SuperDBError('One of the defined values aren\'t a string, number, object, array, undefined or a boolean');
