...
**Released v1.0.0**. See [CHANGELOG](https://github.com/orkestral/SuperDB/blob/master/CHANGELOG.md).


## Installation
- `npm install superdb.js --save`.

_I recommend not using versions lower than **1.0.0** or being aware of updates to the library._
