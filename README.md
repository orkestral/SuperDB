...
**Released v0.0.3**. See [CHANGELOG](https://github.com/orkestral/SuperDB/blob/master/CHANGELOG.md).


## Installation
- `npm install superdb.js --save`.

_I recommend not using versions lower than **0.0.3** or being aware of updates to the library._
